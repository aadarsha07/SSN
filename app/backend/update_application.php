...
// General Details
$id = htmlspecialchars(basename($_SERVER['REQUEST_URI']));
...
$user_photo_file_name = $_POST['user_photo_name'];
$citizenship_file_name = $_POST['citizenship_card_name'];
$passport_file_name = $_POST['passport_name'];
$$license_file_name = $_POST['license_name'];
$pancard_file_name = $_POST['pancard_name'];

global $error;
$error = [];

// Insert General Details
require("query/update_application_query.php");
    ...
    if($query){
        ...
        if(empty($error)) {
            ...
            c_n='$c_n',
            c_file='$citizenship_file_name',
            pass_n='$pass_n',
            pass_file='$passport_file_name',
            lic_n='$lic_n',
            lic_file='$license_file_name',
            pan_n='$pan_n',
            pan_file='$pancard_file_name'
            WHERE detail_id=$id";
            $query = $conn->query($sql);
        }
        else {
        ...
        }
        {
            if($query) {
                ...
                header("Location:../../frontend/super_admin/new_applications.php");
            }
